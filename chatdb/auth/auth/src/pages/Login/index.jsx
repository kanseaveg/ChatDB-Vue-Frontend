    ...
    const sendEmail = (i) => {
        ...
        if (email && regex.test(email)) {
            ...
            axios({
                ...
                method: 'GET',
                url: `${URL}/admin/isExists?email=${email}`,
            }).then(res => {
    ...
    const sendCaptcha = (i) => {
        debounce(() => {
            ...
            axios({
                ...
                url: `${URL}/user/captcha?captchaKey=${myUuid}`,
            }).then(res => {
    ...
    const onFinish = (values) => {
        ...
        axios({
            ...
            if (res.data.code !== 200) {
                ...
                localStorage.setItem('adminId', res.headers.userid)
                navigate('/home')
            }
        })
    };
    const onFinishRegister = (values) => {
        const { adminname, password, email, phone, captchaCode, emailCode, inviteCode } = values
