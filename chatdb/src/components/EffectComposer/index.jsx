...
export default function MyEffectComposer() {
    const create = () => {
        ...
        function init() {
            ...
            renderer.domElement.className = 'EffectComposer'
    ...
    //         renderer.setPixelRatio(window.devicePixelRatio);
    //         renderer.setSize(window.innerWidth, window.innerHeight);
    //         renderer.domElement.className = 'Bird'
    ...
    // }
    useEffect(() => {
        if (!document.querySelector('.EffectComposer')) {
            create()
            // createBird()
        }
    }, [])
